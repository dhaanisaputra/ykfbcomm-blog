                        ...
                        <article class="card article-card">
                            <a href="{{ route('read_post', single_latest_post()->post_slug) }}">
                                <div class="card-image">
                                    ...
                                    {{-- {{asset('back/dist/img/posts-upload/thumbnails/resized_'.$post->featured_image)}} --}}
                                    <img loading="lazy" decoding="async"
                                        src="{{ asset('back/dist/img/posts-upload/' . single_latest_post()->featured_image) }}"
                        ...
                        <article class="card article-card article-card-sm h-100">
                            <a href="{{ route('read_post', $item->post_slug) }}">
                                <div class="card-image">
                                    ...
                                    <img loading="lazy" decoding="async"
                                        src="{{ asset('back/dist/img/posts-upload/' . $item->featured_image) }}"
                                        alt="Post Thumbnail" class="w-100">
                                </div>
                            </a>
