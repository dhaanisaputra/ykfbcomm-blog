<footer class="bg-dark mt-2">
    <div class="container section">
        <div class="row">
            <div class="col-lg-10 mx-auto text-center">
                <a class="d-inline-block mb-1 pb-2" href="/ykfb">
                    <img loading="prelaod" decoding="async" class="img-fluid"
                        src="{{ url('/back/dist/img/logo-favicon/' . blogInfo()->blog_logo) }}"
                        ...
                        <div class="flex justify-center space-x-6">
                            @foreach ($getSocmed as $item)
                                <a class="text-red-500 hover:text-opacity-75" href="" target=""
                                    ...
                                    {{-- <svg class="icon icon-tabler icons-tabler-outline icon-tabler-brand-youtube"
                                    ...
                                    {{-- <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                        fill="currentColor" class="w-8 h-8" viewBox="0 0 18 18">
                                        <path
                                ...
                                <a class="text-pink-600 hover:text-opacity-75" href="{{ $item->bsm_instagram }}"
                                    ...
                                    {{-- <svg class="icon icon-tabler icons-tabler-outline icon-tabler-brand-instagram"
                                        xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                        stroke-linecap="round" stroke-linejoin="round">
                                        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
    ...
    <div class="copyright bg-dark content">&copy;
        ...
        </script> | Designed &amp; Developed By <a href="/ykfb">{{ blogInfo()->blog_name }}</a>
    </div>
</footer>
