        ...
        <div class="card-body">
            ...
            <form wire:submit.prevent="LoginHandler()" method="post" autocomplete="off" novalidate="">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" placeholder="Enter your email or username" autocomplete="off" wire:model="login_id">
                    @error('login_id')
                ...
                <div class="mb-2">
                    ...
                    <div class="input-group input-group-flat">
                        <input type="password" class="form-control" placeholder="Enter your password" autocomplete="off" wire:model="password">
